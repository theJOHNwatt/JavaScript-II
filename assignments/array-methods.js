...
// // Problem 1 Director wants to add company to the running bibs. Create a new array with first name, last name, and company name. This array will contain just strings. 

// let runnerBib = [];

// runners.forEach ((runnerID) => { 
//   runnerBib.push (`${runnerID.first_name} ${runnerID. last_name} Company:${runnerID.company_name}`);
// });

// console.log (runnerBib);

// // Problem 2 Director wants to send out a special thank you note to all donations > $199. 

// let donationOver = runners.filter ((item) => {
//   return item.donation >= 200;
// });

// console.log (donationOver);

// // Problem 3 average donation

// let averageDonation =  runners.reduce ((accumulator, item) => {
//   return accumulator + item.donation / 50;
// },0);
// console.log(`Average Donation Amount:$${Math.ceil(averageDonation)}`);
